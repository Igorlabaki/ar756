...
export interface ISendAgendarVisitaEmailParams{
    email:string | undefined,
    nome:string| undefined,
    orcamentoId:string | undefined
}

class SendAgendarVisitaEmailCase {
    async execute( {email,nome,orcamentoId} : ISendAgendarVisitaEmailParams ){
        ...
        const mailOptions = {
            ...
            to:     email,
            subject: 'Agendar uma visita na AR756',
            html: `
                    ...
                    <tr>
                        ...
                        <table style="background-color: white; margin: auto; padding: 20px; width: 50%; height: 690px; border-radius: 10px;">
                            ...
                            <td style="text-align: center;">
                                ...
                                <p style="font-size: 18px; width: 60%; margin: 10px auto; text-align: center;">Agradecemos o seu interesse em conhecer a AR756.Caso queria agendar uma visita por gentileza clique no botão abaixo.</p>
                                <div style="width: 100%; text-align: center;margin-top: 40px;">
                                <a href="http://localhost:3000/orcamento/byId/${orcamentoId}" style="text-decoration: none;">
                                    <button style="background-color: black; color: white; font-size: 20px; padding: 10px 20px; border-radius: 5px; display: inline-block;">Agendar Visita</button>
                                </a>
                                </div>
                                <h2 style="font-size: 18px; width: 60%; margin: 10px auto; text-align: center; margin-top: 40px;">SIGA-NOS</h2>
...
export {SendAgendarVisitaEmailCase}  