...
export const homeGridImages = [
    { position: 1,url: "/images/piscina-frente.jpeg", alt: "Piscina", gridPosition: "col-start-1 col-end-5 row-start-1 row-end-6" },
    { position: 2,url: "/images/salao-exterior-sofas.jpeg", alt: "Salao exterior",gridPosition: "col-start-5 col-end-7 row-start-1 row-end-3" },
    { position: 3,url: "/images/salao-exterior-geral.jpeg", alt: "Salao exterior", gridPosition: "col-start-5 col-end-7 row-start-3 row-end-6" },
